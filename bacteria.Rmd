...
####Classify bacteria
Use classification in taxize to classify to order all bacteria in master list. Note this currently only does part of dataset, would take ~8 hours to do all. Input: bacteria_species.Rdata. Output: bacteria_species_out.Rdata
