...
####label pathogens as zoonotic, human only, or wild only. output: bacteria_pathogenic_mammals. Input: G_classified 
```{r R_human_zoonotic_non_zoonotic}
source("R_human_zoonotic_non_zoonotic1.R")
```

####check that all pathogenic bacteria are present in list of all bacteria. Output:  bacteria_species_out2.Rdata
```{r}
